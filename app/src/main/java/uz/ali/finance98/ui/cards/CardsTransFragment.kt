...
class CardsTransFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        var root=inflater.inflate(R.layout.fragment_cards_trans, container, false)
        recyclerView=root.findViewById(R.id.cards_recycler_trans)
